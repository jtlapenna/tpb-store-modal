  ...
  function build(){ 
    ...
    setTimeout(function() {
      ...
      setTimeout(function() {
        ...
        console.log('Category Stations - Form factor buttons should be visible after animation');
        ...
        setInterval(function() {
          ...
          currentButtons.forEach(function(btn) {
            if (btn.style.opacity !== '1' || btn.style.visibility !== 'visible') {
              console.log('Category Stations - Fixing invisible button:', btn.textContent);
              btn.style.setProperty('opacity', '1', 'important');
              btn.style.setProperty('visibility', 'visible', 'important');
            }
          });
