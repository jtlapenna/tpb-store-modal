...
class PackedPackagesMetaDataBuilder
{
    ...
    public function create_meta_data()
    {
        ...
        foreach ($this->shipment->packages as $package) {
            ...
            $packed_packages[] = ['package' => isset($package->description) ? $package->description : __('Custom', 'flexible-shipping-ups'), 'items' => $items, 'weight' => $package->weight, 'dimensions' => $package->dimensions, 'package_type' => $package->package_type];
        }
