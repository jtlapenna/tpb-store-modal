...
use UpsProVendor\Octolize\Onboarding\PluginUpgrade\MessageFactory\LiveRatesFsRulesTable;
use UpsProVendor\Octolize\Onboarding\PluginUpgrade\PluginUpgradeMessage;
use UpsProVendor\Octolize\Onboarding\PluginUpgrade\PluginUpgradeOnboardingFactory;
	...
	public function init_upgrade_onboarding(): void {
		...
		$upgrade_onboarding->add_upgrade_message(
			new PluginUpgradeMessage(
				...
				__( 'New way to use REST API', 'flexible-shipping-ups-pro' ),
				sprintf(
					// Translators: %1$s and %2$s are placeholders for the link to the documentation.
					__( 'We\'re excited to announce a new method for accessing real-time shipping rates through the UPS REST API. From now on, you can use your own UPS application to connect to API and retrieve accurate live rates. This feature requires additional configuration. For more information, please %1$svisit our documentation%2$s.', 'flexible-shipping-ups-pro' ),
