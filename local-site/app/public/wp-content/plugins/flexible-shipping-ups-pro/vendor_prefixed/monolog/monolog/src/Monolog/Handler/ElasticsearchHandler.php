...
use UpsProVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use UpsProVendor\Monolog\Logger;
use UpsProVendor\Monolog\Formatter\FormatterInterface;
use UpsProVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use UpsProVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use UpsProVendor\Elasticsearch\Client;
use UpsProVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use UpsProVendor\Elastic\Elasticsearch\Client as Client8;
/**
