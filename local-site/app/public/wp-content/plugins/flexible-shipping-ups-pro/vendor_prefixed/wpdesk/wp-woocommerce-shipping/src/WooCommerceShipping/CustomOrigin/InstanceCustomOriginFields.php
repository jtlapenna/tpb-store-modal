...
class InstanceCustomOriginFields extends CustomOriginFields
{
    ...
    {
        return __('Origin Settings for this Shipping Method', 'flexible-shipping-ups-pro');
    }
    /**
     * @return string
     */
    ...
    {
        return __('Enable custom origin for this shipping method', 'flexible-shipping-ups-pro');
    }
    /**
     * @return string
     */
    ...
    {
        return __('Use this option to use a different shipper\'s address for this shipping method.', 'flexible-shipping-ups-pro');
    }
}
