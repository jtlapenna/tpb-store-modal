...
if (!\class_exists('UpsProVendor\WPDesk_Logger')) {
    ...
    class WPDesk_Logger
    {
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-shipping-ups-pro'), 'emergency' => \__('Emergency', 'flexible-shipping-ups-pro'), 'alert' => \__('Alert', 'flexible-shipping-ups-pro'), 'critical' => \__('Critical', 'flexible-shipping-ups-pro'), 'error' => \__('Error', 'flexible-shipping-ups-pro'), 'warning' => \__('Warning', 'flexible-shipping-ups-pro'), 'notice' => \__('Notice', 'flexible-shipping-ups-pro'), 'info' => \__('Info', 'flexible-shipping-ups-pro'), 'debug' => \__('Debug', 'flexible-shipping-ups-pro')];
        }
        /**
         * @param string $level
         * @param string $source
