 ...
 */
use UpsProVendor\WPDesk\License\ActivationForm\AjaxHandler;
?>
<div id="<?php 
...
?>";
			let alert_text = "<?php 
echo \esc_attr(\__('The action failed with an error: ', 'flexible-shipping-ups-pro'));
?>";
			let enter_license_key = "<?php 
echo \esc_attr(\__('Enter license key', 'flexible-shipping-ups-pro'));
?>";
