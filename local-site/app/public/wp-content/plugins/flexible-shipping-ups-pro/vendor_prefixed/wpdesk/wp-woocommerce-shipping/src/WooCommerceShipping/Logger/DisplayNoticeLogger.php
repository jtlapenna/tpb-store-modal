 ...
 */
namespace UpsProVendor\WPDesk\WooCommerceShipping\Logger;

use UpsProVendor\Psr\Log\LoggerInterface;
use UpsProVendor\Psr\Log\LoggerTrait;
...
class DisplayNoticeLogger implements LoggerInterface
{
    ...
    private function show($message, array $context, $type)
    {
        ...
        $dump .= sprintf('<br/><div><i>%1$s</i></div>', __('This notice is visible only for Administrators.', 'flexible-shipping-ups-pro'));
