...
use UpsProVendor\Octolize\WooCommerceShipping\Ups\OAuth\OAuthField;
...
class UpsShippingMethod extends ShippingMethod implements ShippingMethod\HasFreeShipping, ShippingMethod\HasCustomOrigin, ShippingMethod\HasRateCache
{
    ...
    private function prepare_description()
    {
        ...
        return sprintf(
            ...
            __('Dynamically calculated UPS live rates based on the established UPS API connection. %1$sLearn more →%2$s', 'flexible-shipping-ups-pro'),
