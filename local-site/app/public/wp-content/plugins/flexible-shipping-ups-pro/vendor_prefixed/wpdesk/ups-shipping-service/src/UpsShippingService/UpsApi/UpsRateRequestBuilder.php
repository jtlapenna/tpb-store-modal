...
class UpsRateRequestBuilder
{
     ...
     * @param \WPDesk\AbstractShipping\Shipment\Package $shipment_package .
     */
    private function set_insurance_if_enabled(Package $ups_package, \UpsProVendor\WPDesk\AbstractShipping\Shipment\Package $shipment_package)
    {
     ...
     */
    private function set_package_weight_if_present(PackageWeight $ups_package_weight, \UpsProVendor\WPDesk\AbstractShipping\Shipment\Package $shipment_package)
    {
     ...
     * @throws UnitConversionException .
     */
    private function set_dimensions_if_present(Package $ups_package, \UpsProVendor\WPDesk\AbstractShipping\Shipment\Package $shipment_package)
    {
