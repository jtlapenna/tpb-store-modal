...
?><div class="ups-label-advertisement">
	<?php 
\esc_html_e('Save time with automated shipping fulfillment, generate and download the print-ready shipping labels and track parcels directly in your store.', 'flexible-shipping-ups-pro');
?>
	<a href="<?php 
echo \esc_url($url);
?>" target="_blank"><?php 
echo \esc_html__('Get UPS Label plugin', 'flexible-shipping-ups-pro');
?></a> <a href="#" class="ups-label-advertisement-close"><?php 
\esc_html_e('[x]', 'flexible-shipping-ups-pro');
?></a>
</div>
<script>
