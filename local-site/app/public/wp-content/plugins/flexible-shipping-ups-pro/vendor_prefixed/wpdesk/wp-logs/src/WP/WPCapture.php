...
class WPCapture
{
    ...
    private function add_notice_for_dir($dir)
    {
        new \UpsProVendor\WPDesk\Notice\Notice(sprintf(
            ...
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-shipping-ups-pro'),
            $dir
    ...
    private function add_notice_for_file($file)
    {
        new \UpsProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-shipping-ups-pro'),
            $file
        ), \UpsProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
