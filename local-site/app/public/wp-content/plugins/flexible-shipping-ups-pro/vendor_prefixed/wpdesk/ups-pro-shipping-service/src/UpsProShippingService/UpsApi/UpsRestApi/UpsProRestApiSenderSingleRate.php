...
use UpsProVendor\Octolize\Ups\RestApi\UpsRestApiSenderSingleRate;
use UpsProVendor\Psr\Log\LoggerInterface;
class UpsProRestApiSenderSingleRate extends UpsRestApiSenderSingleRate
{
    ...
    public function __construct(RestApiClient $client, string $service_code, LoggerInterface $logger, bool $is_testing = \false, bool $is_tax_enabled = \true, bool $request_time_in_transit = \false)
    {
        parent::__construct($client, $service_code, $logger, $is_testing, $is_tax_enabled);
