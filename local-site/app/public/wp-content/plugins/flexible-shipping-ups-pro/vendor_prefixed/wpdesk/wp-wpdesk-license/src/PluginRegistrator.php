...
class PluginRegistrator implements PluginRegistratorInterface
{
    ...
    {
        if (\UpsProVendor\WPDesk\License\LicenseServer\PluginRegistrator::should_use_license_server()) {
            $this->true_registrator = new \UpsProVendor\WPDesk\License\LicenseServer\PluginRegistrator($plugin_info);
        } else {
