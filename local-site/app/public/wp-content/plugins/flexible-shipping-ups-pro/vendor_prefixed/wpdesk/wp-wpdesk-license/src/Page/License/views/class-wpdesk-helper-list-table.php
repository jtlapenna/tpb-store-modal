...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-shipping-ups-pro'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-shipping-ups-pro'), 'product_status' => \__('Subscription Status', 'flexible-shipping-ups-pro'), 'product_license' => \__('Subscription Data', 'flexible-shipping-ups-pro')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-shipping-ups-pro');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-shipping-ups-pro');
        }
        return $status;
    }
