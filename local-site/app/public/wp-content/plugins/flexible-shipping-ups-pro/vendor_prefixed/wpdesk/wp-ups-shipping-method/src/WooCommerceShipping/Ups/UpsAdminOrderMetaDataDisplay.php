...
class UpsAdminOrderMetaDataDisplay extends AdminOrderMetaDataDisplay
{
    ...
    {
        $this->add_interpreter(new SingleAdminOrderMetaDataInterpreterImplementation(UpsMetaDataBuilder::META_UPS_ACCESS_POINT, __('UPS Access Point', 'flexible-shipping-ups-pro')));
        $this->add_interpreter(new SingleAdminOrderMetaDataInterpreterImplementation(UpsMetaDataBuilder::META_UPS_SERVICE_CODE, __('UPS Service Code', 'flexible-shipping-ups-pro')));
        $this->add_interpreter(new SingleAdminOrderMetaDataInterpreterImplementation(self::META_FALLBACK_REASON, __('Fallback reason', 'flexible-shipping-ups-pro')));
        $this->add_interpreter(new SingleAdminOrderMetaDataInterpreterImplementation(UpsMetaDataBuilder::META_UPS_ACCESS_POINT_ADDRESS, __('UPS Access Point Address', 'flexible-shipping-ups-pro')));
    }
}
