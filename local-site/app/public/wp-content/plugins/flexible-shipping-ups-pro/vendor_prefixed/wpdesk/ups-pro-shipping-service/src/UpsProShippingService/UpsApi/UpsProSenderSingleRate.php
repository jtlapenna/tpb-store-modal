...
class UpsProSenderSingleRate extends UpsSenderSingleRate
{
    ...
    public function __construct($access_key, $user_id, $password, $service_code, LoggerInterface $logger, $is_testing = \false, $is_tax_enabled = \true, $request_time_in_transit = \true)
    {
