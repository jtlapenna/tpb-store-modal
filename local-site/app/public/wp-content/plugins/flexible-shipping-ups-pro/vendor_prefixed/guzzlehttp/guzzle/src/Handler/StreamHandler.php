...
use UpsProVendor\Psr\Http\Message\RequestInterface;
use UpsProVendor\Psr\Http\Message\ResponseInterface;
use UpsProVendor\Psr\Http\Message\StreamInterface;
/**
...
class StreamHandler
{
    ...
    private function invokeStats(array $options, RequestInterface $request, $startTime, ResponseInterface $response = null, $error = null)
    {
        if (isset($options['on_stats'])) {
            $stats = new TransferStats($request, $response, \UpsProVendor\GuzzleHttp\_current_time() - $startTime, $error, []);
