...
namespace UpsProVendor\Psr\Log\Test;

use UpsProVendor\Psr\Log\LoggerInterface;
use UpsProVendor\Psr\Log\LogLevel;
use UpsProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('UpsProVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('UpsProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('UpsProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
