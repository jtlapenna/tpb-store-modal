...
use UpsProVendor\Octolize\WooCommerceShipping\Ups\OAuth\Exceptions\RefreshTokenException;
...
class RefreshTokenWithRefreshToken implements RefreshToken
{
    ...
    public function refresh(): void
    {
        if (!$this->token_option->get_refresh_token()) {
            throw new RefreshTokenException(__('Refresh token is invalid.', 'flexible-shipping-ups-pro'));
        }
        ...
        if (is_wp_error($response)) {
            ...
            if (isset($response_body['status'])) {
                ...
                throw new RefreshTokenException(__('Error during refresh.', 'flexible-shipping-ups-pro'));
            }
        }
    }
    /**
