...
namespace UpsProVendor\Octolize\Blocks\PickupPoint;
...
class StoreEndpoint implements Hookable
{
    ...
    public static function data_callback(): array
    {
        ...
        return apply_filters('octolize-pickup-point-blocks-' . self::$integration_name . '-data', [static::$field_name => $point_id, 'default_options' => apply_filters('octolize-pickup-point-blocks-' . self::$integration_name . '-default_options', [['label' => __('Please enter at least 3 characters', 'flexible-shipping-ups-pro'), 'value' => '']], $point_id), 'field_label' => __('Selected pickup point', 'flexible-shipping-ups-pro'), 'button_label' => __('Select from map', 'flexible-shipping-ups-pro')]);
    }
    public static function schema_callback(): array
    {
        return [self::$field_name => ['description' => __('Select pickup point', 'flexible-shipping-ups-pro'), 'type' => ['string'], 'context' => ['view', 'edit'], 'readonly' => \true, 'optional' => \false, 'arg_options' => ['validate_callback' => function ($value) {
            return \true;
        }]]];
    }
