...
namespace UpsProVendor\Octolize\Tracker;

use UpsProVendor\Octolize\Tracker\DeactivationTracker\OctolizeReasonsFactory;
use UpsProVendor\Octolize\Tracker\OptInNotice\OptInNotice;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplay;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAlways;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAndConditions;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterPresent;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterValue;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayOrConditions;
use UpsProVendor\Octolize\Tracker\OptInNotice\ShouldDisplayShippingMethodInstanceSettings;
...
class TrackerInitializer implements HookableCollection
{
    ...
    public function hooks()
    {
        ...
        $tracker_consent = new \UpsProVendor\WPDesk_Tracker_Persistence_Consent();
     ...
     */
    public static function create_from_plugin_info(\UpsProVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
     ...
     * @return TrackerInitializer
     */
    public static function create_from_plugin_info_for_shipping_method(\UpsProVendor\WPDesk_Plugin_Info $plugin_info, string $shipping_method_id, ReasonsFactory $reasons_factory = null)
    {
        $shops = $plugin_info->get_plugin_shops();
        $shop_url = $shops[get_locale()] ?? $shops['default'] ?? 'https://octolize.com';
