...
\esc_attr_e('Shipping Extensions by', 'flexible-shipping-ups-pro');
?>"
     data-header_description="<?php 
\esc_attr_e('Dive into a system of Octolize ecommerce shipping plugins for WooCommerce. Don’t lose your customers, time and money. Let our plugins secure your sales!', 'flexible-shipping-ups-pro');
?>"
     data-header_promo="<?php 
echo \esc_attr(\wp_json_encode($header_promo));
?>"
     data-default_category="<?php 
\esc_attr_e('All', 'flexible-shipping-ups-pro');
?>"
     data-text_filter="<?php 
\esc_attr_e('Filter plugins:', 'flexible-shipping-ups-pro');
?>"
     data-categories="<?php 
