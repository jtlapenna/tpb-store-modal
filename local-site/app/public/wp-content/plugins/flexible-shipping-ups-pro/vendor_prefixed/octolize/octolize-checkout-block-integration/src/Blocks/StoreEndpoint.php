...
class StoreEndpoint implements Hookable
{
    ...
    {
        return apply_filters('octolize-checkout-block-integration-' . $this->integration_name . '-schema', [$this->field_name => ['description' => __('Field', 'flexible-shipping-ups-pro'), 'type' => ['string'], 'context' => ['view', 'edit'], 'readonly' => \false, 'optional' => \false, 'arg_options' => ['validate_callback' => function ($value) {
            return \true;
        }]]]);
    }
}
