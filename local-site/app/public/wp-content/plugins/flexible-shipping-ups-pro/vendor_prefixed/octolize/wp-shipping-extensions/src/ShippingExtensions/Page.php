...
use UpsProVendor\Octolize\ShippingExtensions\Plugin\Plugin;
use UpsProVendor\Octolize\ShippingExtensions\Plugin\PluginFactory;
use UpsProVendor\Octolize\ShippingExtensions\Plugin\PluginSorter;
use UpsProVendor\Octolize\ShippingExtensions\Tracker\ViewPageTracker;
...
class Page implements Hookable
{
    ...
    {
        add_submenu_page(self::PARENT_SLUG, _x('Shipping Extensions', 'Page title', 'flexible-shipping-ups-pro'), $this->get_menu_title(), 'manage_options', self::MENU_SLUG, [$this, 'render_page']);
    }
    /**
     * @return void
     */
    ...
    {
        $menu_title = nl2br(_x("Shipping\nExtensions", 'Menu Title', 'flexible-shipping-ups-pro'));
