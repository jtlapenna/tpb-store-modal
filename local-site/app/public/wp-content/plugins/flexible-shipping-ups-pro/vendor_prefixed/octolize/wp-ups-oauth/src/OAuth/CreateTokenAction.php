...
use UpsProVendor\Octolize\WooCommerceShipping\Ups\OAuth\Actions\CreateToken;
use UpsProVendor\Octolize\WooCommerceShipping\Ups\OAuth\Exceptions\CreateTokenException;
    ...
    public function create_token()
    {
        if (isset($_GET['app']) && $_GET['app'] === $this->app && isset($_GET['ups-oauth-code']) && $this->verify_nonce()) {
            ...
            try {
                ...
                $create_token->handle();
                new Notice(__('Successfully authorized.', 'flexible-shipping-ups-pro'), Notice::NOTICE_TYPE_SUCCESS);
