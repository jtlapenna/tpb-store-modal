...
class CheckoutIntegration extends \UpsProVendor\Octolize\Blocks\CheckoutIntegration
{
    ...
    private function register_main_integration(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration', 'flexible-shipping-ups-pro', $this->plugin_dir . '/lang');
    }
    ...
    public function register_shipping_workshop_block_editor_scripts(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration-editor', 'flexible-shipping-ups-pro', $this->plugin_dir . '/lang');
    }
    public function register_shipping_workshop_block_frontend_scripts(): void
    {
        ...
        wp_set_script_translations($this->integration_name . '-blocks-integration-frontend', 'flexible-shipping-ups-pro', $this->plugin_dir . '/lang');
    }
