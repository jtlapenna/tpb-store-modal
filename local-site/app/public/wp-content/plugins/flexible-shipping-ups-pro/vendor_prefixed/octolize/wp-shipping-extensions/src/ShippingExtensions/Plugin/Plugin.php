...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'flexible-shipping-ups-pro') : __('Buy plugin →', 'flexible-shipping-ups-pro');
    }
}
