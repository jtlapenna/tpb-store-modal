...
use AcVendor\Doctrine\Common\Annotations\AnnotationRegistry;
use AcVendor\Doctrine\Common\Annotations\Reader;
use AcVendor\Doctrine\Common\Annotations\SimpleAnnotationReader;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()->getClassAnnotation($class, 'AcVendor\\DI\\Annotation\\Injectable');
