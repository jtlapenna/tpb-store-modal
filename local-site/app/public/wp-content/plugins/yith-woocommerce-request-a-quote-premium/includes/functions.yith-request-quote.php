...
if ( ! function_exists( 'yith_ywraq_get_product_meta' ) ) {
	...
	function yith_ywraq_get_product_meta( $raq, $echo = true, $show_price = true ) {
		...
		if ( isset( $raq['variation'] ) && is_array( $raq['variation']) )  {
			$raq['variations'] = $raq['variation'];
		}
...
if ( ! function_exists( 'yith_ywraq_get_product' ) ) {
	/**
	 * Returns the product or the dummy product if it's an email preview
	 *
	 * @param int $product_id The product ID.
	 * @return false|null|WC_Product
	 */
	function yith_ywraq_get_product( $product_id ) {
		if ( empty( $product_id ) && apply_filters( 'woocommerce_is_email_preview', false ) ) {
			return YITH_YWRAQ_Email::get_dummy_product();
		} else {
