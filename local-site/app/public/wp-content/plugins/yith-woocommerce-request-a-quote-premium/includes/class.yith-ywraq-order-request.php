...
class YITH_YWRAQ_Order_Request {
	...
	public function raq_order_action( $post_id = 0, $post = null ) {
		...
		if ( $this->quote_sent || ! isset( $_POST['yit_metaboxes'] ) || ! isset( $_POST['yit_metaboxes']['_ywraq_safe_submit_field'] ) || empty( $_POST['yit_metaboxes']['_ywraq_safe_submit_field'] ) || 'acf/validate_save_post' === $_POST['action'] ) { //phpcs:ignore WordPress.Security.NonceVerification.Missing
			return;
		}
