...
== Changelog ==
= 4.37.0 – Released on 15 September 2025 =
* New: support for WooCommerce 10.2
* Update: YITH plugin framework

= 4.36.0 – Released on 5 August 2025 =
* New: support for WooCommerce 10.1
* Update: YITH plugin framework
* Fix: prevent AJAX loading call if no variable product is found
* Fix: remove guest AJAX calls for the exclusion lists
* Fix: add support for WooCommerce Email Preview

= 4.35.0 – Released on 8 July 2025 =
* New: support for WooCommerce 10.0
* Update: YITH plugin framework

= 4.34.0 – Released on 29 May 2025 =
* New: support for WooCommerce 9.9
* Update: YITH plugin framework
* Fix: issue with wrong input ID for the state type fields

= 4.33.0 – Released on 23 April 2025 =
* New: support for WordPress 6.8
* Update: YITH plugin framework
* Tweak: improve compatibility with YITH WooCommerce Multi Vendor
* Fix: use wc_order functions and methods in the cron tasks
* Fix: improved compatibility with WooCommerce Product Table plugin: ensured the quote button is correctly displayed when lazy load is enabled by adding support for the 'wcpt_load_products' Ajax action
* Fix: issue when counting the total number of quotes for a specific status
* Fix: using wrong column from posts table to check the quote status
* Fix: quotes expiring before the number of days configured

= 4.32.0 – Released on 17 March 2025 =
* New: support for WooCommerce 9.8
* Update: YITH plugin framework
* Fix: add-ons added to quote being replaced
* Fix: update vendor suborders to default 'New Quote Request'
* Fix: issue with quote reminder email
* Fix: quote count error when HPOS is enabled

= 4.31.1 – Released on 19 February 2025 =
* Fix: added fix if the parent of a composite product has a price zero
* Fix: added fix when preview PDF and test email is done so that a new expiration date is not saved
* Dev: added new filter yith_ywraq_redirect_url

= 4.31.0 – Released on 5 February 2025 =
* New: support for WooCommerce 9.7
* Update: YITH plugin framework
* Fix: 'Email with Quote' was sent twice in installations with Advanced Custom Fields
* Fix: add space to avoid incorrect email formatting in plain template
* Fix: issue in the multiselection field in the default form
* Fix: add check on billing address to avoid error if missing
* Fix: add tax calculation in the admin quote template
* Fix: add responsive width to Add to Quote popup on cart

= 4.30.0 – Released on 12 December 2024 =
* New: support for WordPress 6.7
* New: support for WooCommerce 9.5
* Update: YITH plugin framework
* Fix: quantity of add-ons passed to quote list
* Fix: submit RAQ form on cart after update the cart
* Fix: quantities of add-ons type Product after adding to cart from quote
* Dev: added new filter "ywraq_my_account_my_quotes_query_limit"
* Dev: deleted unused options files
* Dev: added product add-ons quantities meta to raq order
* Dev: added wc-enhanced-select class to custom template selector
